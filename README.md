# @omegion1npm/minima-saepe-quos · [![GitHub license](https://img.shields.io/badge/license-MIT-blue.svg)](https://github.com/omegion1npm/minima-saepe-quos/blob/master/LICENSE) [![npm](https://img.shields.io/npm/v/@omegion1npm/minima-saepe-quos.svg)](https://www.npmjs.com/package/@omegion1npm/minima-saepe-quos) ![Package Status](https://github.com/omegion1npm/minima-saepe-quos/workflows/Package/badge.svg) ![Test Status](https://github.com/omegion1npm/minima-saepe-quos/workflows/Test/badge.svg)
...
```sh
npm install @omegion1npm/minima-saepe-quos --save
```

## Usage

```js
const t = require('@omegion1npm/minima-saepe-quos')
...
[MIT](https://github.com/omegion1npm/minima-saepe-quos/blob/master/LICENSE)
